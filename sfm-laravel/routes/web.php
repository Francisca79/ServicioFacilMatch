...
Route::get('/olvide-contrasena', [PasswordResetController::class, 'showForgot']);
Route::post('/olvide-contrasena', [PasswordResetController::class, 'sendLink']);
Route::get('/restablecer-contrasena/{token}', [PasswordResetController::class, 'showReset'])->name('password.reset');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('panel/admin')->middleware('role:admin')->group(function () {
        ...
        Route::get('/clientes', [AdminPanelController::class, 'clientes']);
        Route::get('/clientes/{id}', [AdminPanelController::class, 'showCliente'])->whereNumber('id');
        Route::get('/advertencias', [AdminPanelController::class, 'advertencias']);
        Route::get('/pagos', [AdminPanelController::class, 'pagos']);
        Route::get('/reportes', [AdminPanelController::class, 'reportes']);
        Route::post('/clientes/{id}/bloqueo', [AdminPanelController::class, 'toggleBloqueo'])->whereNumber('id');
        Route::post('/usuarios/{id}/bloqueo', [AdminPanelController::class, 'toggleBloqueo'])->whereNumber('id');
    ...
    Route::prefix('panel/profesional')->middleware('role:profesional')->group(function () {
        ...
        Route::post('/solicitudes/responder', [ProfesionalPanelController::class, 'responderSolicitud']);
        Route::post('/pagos/confirmar', [ProfesionalPanelController::class, 'confirmarCobro']);
